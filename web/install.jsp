    ...
    <body>
        ...
        <%
            ...
            String dataHabitacions[] = new String[]{
                ...
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN,'C/Mossen martí 33 3r 3a', 'valls','Room in the city center, very well connected. It has a supermarket nearby and very nice views. Habitacio amb molta llum, sembla Lloret.',1,500.10,'MOBLADA','Images/hab1.jpg',0,1,40,20,'UNISEX',"+idsLlogaters.get(3)+")", 
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Major 72','montferri','Suite with double bed and jacuzzi for 2 people at the foot of the bed. Completely renovated with modern design. Option of extra bed.',1,1124.15,'SIMPLE','Images/hab2.jpg',1,1,60,18,'HOME',"+idsLlogaters.get(0)+")", 
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Paisos Catalans 12', 'reus', 'Romantic and nice Suite in Reus, has a living room and bedroom with 2x2m bed. Ideal for a relaxing break as a couple. Complete bathroom, with whirlpool and separate shower, hairdryer, magnifying mirror and Rituals amenities.',1,469.24,'DOBLE','Images/hab3.jpg',0,0,80,20,'DONA',"+idsLlogaters.get(5)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Rambla nova 5', 'tarragona','Feel the sea breeze while watching from your private balcony the beautiful beaches of Tarragona. It offers magnificent premium sea view rooms (30 m2 / 323 sq. Ft.) With extraordinary frontal views of the Mediterranean Sea.',1,99.99,'EXTERIOR','Images/hab4.jpg',1,1,70,2,'UNISEX',"+idsLlogaters.get(6)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Rafael de Casanova', 'valls','See the natural beauty of Valls from these warm, elegant and bright rooms. We put at your disposal rooms with an unbeatable view of the famous Miramar Mountain, with great landscape and natural wealth.',1,1000.90,'SIMPLE','Images/hab5.jpg',1,0,90,30,'UNISEX',"+idsLlogaters.get(1)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 2', 'vallmoll','Room prepared with more space so you can enjoy a comfortable holiday as a couple. It has a large 2x2m King Bed. With full bathroom with bathtub, hairdryer, cosmetic mirror and amenities.',0,120,'INTERIOR','Images/hab6.jpg',1,1,99,10,'UNISEX',null)"
