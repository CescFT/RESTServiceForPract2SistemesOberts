...
<html>
 ...
 /* you have to exclude the id autogenerated from the list of columns if you have use it. */
            ...
            String dataLlogater[] = new String[]{
                "INSERT INTO " + schema + ".LLOGATER (ID, NUMLLOGADES ,COGNOM_LLOGATER,NIF,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,0,'Sanchez','25789635-K',18,0,'Marc','HOME',1)",
                "INSERT INTO " + schema + ".LLOGATER (ID, NUMLLOGADES ,COGNOM_LLOGATER,NIF,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES)  VALUES (NEXT VALUE FOR LLOGATER_GEN,0,'Kornikov','14576984-M',70,1,'Joan','HOME',0)",
                ...
                "INSERT INTO " + schema + ".LLOGATER (ID, NUMLLOGADES ,COGNOM_LLOGATER,NIF,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,0,'Perez','2143657-O',24,0,'Marta','DONA',1)",
                ...
                "INSERT INTO " + schema + ".LLOGATER (ID, NUMLLOGADES ,COGNOM_LLOGATER,NIF,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,0,'Pujades','35955521-V',32,0,'Natalia','DONA',0)",
                "INSERT INTO " + schema + ".LLOGATER (ID, NUMLLOGADES ,COGNOM_LLOGATER,NIF,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,0,'Llobregat','56322214-E',30,1,'Manuela','DONA',0)",};
            ResultSet rsLlo;
            ...
            String dataHabitacions[] = new String[]{
                ...
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,NOM_HABITACIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Rafael de Casanova', 'valls','See the natural beauty of Valls from these warm, elegant and bright rooms. We put at your disposal rooms with an unbeatable view of the famous Miramar Mountain, with great landscape and natural wealth.','Suit Channel',1,1000.90,'SIMPLE','Images/hab5.jpg',1,0,90,30,'UNISEX'," + idsLlogaters.get(1) + ")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,NOM_HABITACIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 2', 'vallmoll','Room prepared with more space so you can enjoy a comfortable holiday as a couple. It has a large 2x2m King Bed. With full bathroom with bathtub, hairdryer, cosmetic mirror and amenities.','Suit 1',0,120,'INTERIOR','Images/hab6.jpg',1,1,99,10,'UNISEX',null)",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,NOM_HABITACIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 3', 'vallmoll','Room prepared with more space so you can enjoy a comfortable holiday as a couple. It has a large 2x2m King Bed. With full bathroom with bathtub, hairdryer, cosmetic mirror and amenities.','Suit 2',0,120,'INTERIOR','Images/hab6.jpg',1,1,99,10,'UNISEX',null)",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,NOM_HABITACIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 4', 'vallmoll','Room prepared with more space so you can enjoy a comfortable holiday as a couple. It has a large 2x2m King Bed. With full bathroom with bathtub, hairdryer, cosmetic mirror and amenities.','Suit 3',0,120,'INTERIOR','Images/hab6.jpg',1,1,99,10,'UNISEX',null)",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,NOM_HABITACIO,OCUPADA,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 5', 'vallmoll','Room prepared with more space so you can enjoy a comfortable holiday as a couple. It has a large 2x2m King Bed. With full bathroom with bathtub, hairdryer, cosmetic mirror and amenities.','Suit 4',0,120,'INTERIOR','Images/hab6.jpg',1,1,99,10,'UNISEX',null)"
            };
            ResultSet rsHab;
