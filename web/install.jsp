    ...
    <body>
        ...
        <%
            ...
            String dataHabitacions[] = new String[]{
                ...
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN,'C/Mossen martí 33 3r 3a', 'valls','Habitació amb molta llum, sembla Lloret.',500.10,'MOBLADA','habitacio_triple_5_182.jpg',0,1,40,20,'UNISEX',"+idsLlogaters.get(3)+")", 
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Major 72','montferri','Molt acollidora.',1124.15,'SIMPLE','habitacio_triple_5_182.jpg',1,1,60,18,'HOME',"+idsLlogaters.get(0)+")", 
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Paisos Catalans 12', 'reus', 'Perfecte per estar en família.',469.24,'DOBLE','habitacio_triple_5_182.jpg',0,0,80,20,'DONA',"+idsLlogaters.get(5)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Rambla nova 5', 'tarragona','Ideal per a excursions amb amics.',99.99,'EXTERIOR','habitacio_triple_5_182.jpg',1,1,70,2,'UNISEX',"+idsLlogaters.get(6)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Rafael de Casanova', 'valls','Molt romàntica.',1000.90,'SIMPLE','habitacio_triple_5_182.jpg',1,0,90,30,'UNISEX',"+idsLlogaters.get(1)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, IMATGE_URL ,FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'Avda. Catalunya 2', 'vallmoll','Es una mica cara.',120,'INTERIOR','habitacio_triple_5_182.jpg',1,1,99,10,'UNISEX',null)"
